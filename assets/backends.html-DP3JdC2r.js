import{_ as n,c as e,o as s,a}from"./app-KNRHhc6K.js";const i={},l=a(`<h1 id="introduction" tabindex="-1"><a class="header-anchor" href="#introduction"><span>Introduction</span></a></h1><p>Les backends seront exécutés par <strong>sesame-daemon</strong> sur requete de sesame orchestrateur</p><h3 id="workflow" tabindex="-1"><a class="header-anchor" href="#workflow"><span>Workflow</span></a></h3><ul><li>Une identité est passée au statut A SYNCHRONISER</li><li>Une action sur le bouton de lancement de la synchronisation va effectuer un déclenchement des backends</li><li>les Backends vont être executés dans l&#39;ordre où il ont été mis dans le repertoire backends (<em>var/lib/sesame-daemon/backend</em>)</li><li>Le daemon enverra le resultat de l&#39;execution à l&#39;orchestrator</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">UI ---&gt; API &lt;--&gt; Daemon &lt;---&gt; Backends </span>
