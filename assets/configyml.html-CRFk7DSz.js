...
<span class="line">    ]</span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="section-mapping" tabindex="-1"><a class="header-anchor" href="#section-mapping"><span>Section mapping</span></a></h3><p>Ce paragraphe, dans le fichier config.yml sert à definir qui va où. Il associe les champs standards de sesame et les champs additionnels avec la valeur du fichier de data</p><h4 id="champs-standards" tabindex="-1"><a class="header-anchor" href="#champs-standards"><span>champs standards</span></a></h4><p>Les champs standards (voir documentation <a href="/configuration/validation" target="_blank" rel="noopener noreferrer">/configuration/validation</a>. Ces champs sont préfixés avec le inetOrgPerson ex :interOrgPerson.title. Sa valeur est le nom de la clé dans le fichier data</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">inetOrgPerson.title: &quot;title&quot;</span>
...
<span class="line">    </span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,59),t=[l];function d(r,c){return n(),s("div",null,t)}const p=e(i,[["render",d],["__file","configyml.html.vue"]]),u=JSON.parse(`{"path":"/import/configyml.html","title":"Configuration de l'import","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"Structure","slug":"structure","link":"#structure","children":[{"level":3,"title":"Section mapping","slug":"section-mapping","link":"#section-mapping","children":[]},{"level":3,"title":"Section additionalFields","slug":"section-additionalfields","link":"#section-additionalfields","children":[]},{"level":3,"title":"Section transforms","slug":"section-transforms","link":"#section-transforms","children":[]}]}],"git":{"updatedTime":1718198362000,"contributors":[{"name":"Alain Abbas","email":"alain.abbas@libertech.fr","commits":2}]},"filePathRelative":"import/configyml.md"}`);export{p as comp,u as data};
