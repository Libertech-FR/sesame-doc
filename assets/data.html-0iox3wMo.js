...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Pour savoir les types supportés se reférer à la documentation</p><p><a href="validation">Documentation pour la définition des données </a></p>`,14),t=[l];function r(d,c){return e(),n("div",null,t)}const o=s(a,[["render",r],["__file","data.html.vue"]]),v=JSON.parse('{"path":"/configuration/data.html","title":"Principe","lang":"fr-FR","frontmatter":{"lang":"fr-FR","title":"Principe","description":"Configuration des données"},"headers":[],"git":{"updatedTime":1760081473000,"contributors":[{"name":"Alain Abbas","email":"alain.abbas@libertech.fr","commits":1},{"name":"Tacx","email":"12997062+tacxou@users.noreply.github.com","commits":1}]},"filePathRelative":"configuration/data.md"}');export{o as comp,v as data};
